...
-- in the "pcv" database.
-------------------------------------------------------------------------------
INSERT INTO "Entidad" (name,shortDescription,url,address,email,phone) VALUES ('Plataforma Coruñesa de Voluntariado', 'Somos una organización que aglutina a distintas asociaciones y llevamos x años realizando labores comunitarias en la provincia de A Coruña','pcv.es','Bajo Mirador los Puentes, A Coruña','support@pcv.es','999999999');
