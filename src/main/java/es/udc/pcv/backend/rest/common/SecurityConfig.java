...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.requiresChannel()
			...
			.antMatchers(HttpMethod.PUT,"/users/myVolunteer/*").hasAnyRole("ADMIN","REPRESENTATIVE")
			.antMatchers(HttpMethod.GET,"/users/myVolunteer/*").hasAnyRole("ADMIN","REPRESENTATIVE")
			...
			.antMatchers(HttpMethod.PATCH,"/admin/update/project/*/ods").hasRole("ADMIN")
			...
			.antMatchers(HttpMethod.GET,"/entity/getLogo").permitAll()
			.antMatchers(HttpMethod.GET,"/entity/getAgreementFile/*").hasAnyRole("ADMIN","REPRESENTATIVE","USER")
			.antMatchers(HttpMethod.GET,"/entity/entity/*").permitAll()
			.antMatchers(HttpMethod.GET,"/entity/getAllEntitiesSelector").permitAll()
			.antMatchers(HttpMethod.POST,"/entity/updateEntity/*").hasAnyRole("ADMIN","REPRESENTATIVE")
			...
			.antMatchers(HttpMethod.POST,"/participation/totalHours/*").hasAnyRole("ADMIN","REPRESENTATIVE")
